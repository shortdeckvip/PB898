...
local EnumSeotdaCardsType = {
    ...
    EnumSeotdaCardsType_DuiZi      = 10, -- 对子(相同月份的两张牌组合，按月份大小排序)
    EnumSeotdaCardsType_GuangDui   = 11, -- 光对(0x11+0x31 或 0x11+0x81)  13光对或18光对
    EnumSeotdaCardsType_38GuangDui = 12, -- 38光对(0x31+0x81)
}
